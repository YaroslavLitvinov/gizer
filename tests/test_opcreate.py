...
def test_insert1():
    ...
    query1 = 'CREATE TABLE IF NOT EXISTS "a_inserts" ("body" TEXT, "created_at" TIMESTAMP, "id_bsontype" INTEGER, "id_oid" TEXT, "title" TEXT, "updated_at" TIMESTAMP, "user_id" TEXT, "idx" BIGINT);'
